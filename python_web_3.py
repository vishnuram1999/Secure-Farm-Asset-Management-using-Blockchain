...
address = web3.toChecksumAddress("0x7FE47FE0CF25433F7A1B8CCCb1b63D822eC35141") #Will convert an upper or lowercase Ethereum address to a checksum address
...
def my_form_post():
    ...
    combine = op(int(text1),str(text5),int(text2),int(text3),int(text4),bool(text6),int(text7))
    result = {
        "output": combine
    }
