...
def my_form_post():
    ...
    combine = op(int(text1), str(text5), int(text2), int(text3), int(text4), bool(text6), str(text7))
    result = {
        "output": combine
    }
