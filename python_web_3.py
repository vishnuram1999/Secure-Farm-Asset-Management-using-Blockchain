...
address = web3.toChecksumAddress("0x003E04AE31c0Fa793edDbe5CB16A7981d7c5e535") #Will convert an upper or lowercase Ethereum address to a checksum address
...
def op1(idValue):    
    dateOfPurchasing = date(2021, 4, 18) #date.today()
    dateOfCultivated = date.today()
...
def my_form_post():
    ...
    comb = op(int(text1), str(text5), int(text2), int(text3), int(text4), str(text7))
    combine = "Updated" 
    result = {
        "output": combine
    }
